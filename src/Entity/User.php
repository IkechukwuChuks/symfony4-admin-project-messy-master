 ...
 */
class User implements SoftDeletableInterface, UserInterface, EquatableInterface
{
    ...
    public function isEqualTo(UserInterface $user): bool
    {
        ...
        if ($user->deleted === false) {
            /*
             * Grant the user access if the user is not deleted
             */
            return true;
        }

        /*
         * Deny the user access if deleted
         */
        return false;
    }
}
